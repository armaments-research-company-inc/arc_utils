...
class DateUtils():
    ...
    def __init__(self, updatedRefTime=datetime(2016, 1, 1, 0, 0, 0),
    ...
    def calculate_timestamp(self, device_timestamp):
        calculated_datetime = (datetime.fromtimestamp(float(device_timestamp) / 1000.)) + timedelta (days = int(self.calculate_no_of_days(self.updatedRefTime, self.defaultRefTime)))
